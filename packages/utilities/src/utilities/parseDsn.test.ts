...
const sslCaCertPath = fileURLToPath(import.meta.resolve("@slonik/test-ssls/root.crt"));
const sslCertPath = fileURLToPath(import.meta.resolve("@slonik/test-ssls/slonik.crt"));
const sslKeyPath = fileURLToPath(import.meta.resolve("@slonik/test-ssls/slonik.key"));
