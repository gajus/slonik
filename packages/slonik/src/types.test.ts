...
export const queryMethods = async (): Promise<void> => {
  ...
  expectTypeOf(maybeOne).toEqualTypeOf<null | unknown>();
  ...
  expectTypeOf(maybeOneFirst).toEqualTypeOf<null | unknown>();
  ...
  expectTypeOf(query).toMatchTypeOf<QueryResult<unknown>>();
